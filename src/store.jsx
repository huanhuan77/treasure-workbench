...
const defaultData = {
  ...
  samples: [
  { id:'s_001', name:'冰格', account:'大号', receiveDate:'2026/4/17', deadline:'2026-05-02', remark:'', status:'unpublished' },
  { id:'s_002', name:'口罩', account:'大号', receiveDate:'2026/4/18', deadline:'2026-05-03', remark:'', status:'unpublished' },
  { id:'s_003', name:'柳丝木洁面乳', account:'大号', receiveDate:'2026/5/7', deadline:'2026-05-22', remark:'', status:'unpublished' },
  { id:'s_004', name:'柳丝木洁颜油', account:'大号', receiveDate:'2026/5/20', deadline:'2026-06-04', remark:'', status:'unpublished' },
  ...
  { id:'s_007', name:'造物者 小美', account:'大号', receiveDate:'2026/5/13', deadline:'2026-05-28', remark:'3条', status:'published' },
  ...
  { id:'s_010', name:'珀芙研蛋白胶原面膜', account:'大号', receiveDate:'2026/5/3', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_011', name:'珀芙研油敏霜', account:'大号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_012', name:'珀芙研闪光棒', account:'大号', receiveDate:'2026/5/3', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_013', name:'珀芙研修护霜小样', account:'大号', receiveDate:'2026/5/16', deadline:'2026-05-31', remark:'', status:'published' },
  ...
  { id:'s_016', name:'衣物香氛挂件', account:'大号', receiveDate:'2026/4/24', deadline:'2026-05-09', remark:'', status:'hit' },
  { id:'s_017', name:'浮汀遮瑕液', account:'大号', receiveDate:'2026/5/16', deadline:'2026-05-31', remark:'出单 佣金10%', status:'hit' },
  { id:'s_018', name:'护魔手机壳', account:'大号', receiveDate:'', deadline:'', remark:'出单 佣金10%', status:'hit' },
  ...
  { id:'s_021', name:'讯姆钢化膜', account:'大号', receiveDate:'2026/3/16', deadline:'2026-03-31', remark:'', status:'published' },
  { id:'s_022', name:'袋鼠妈妈沐浴露洗发水', account:'大号', receiveDate:'2026/4/27', deadline:'2026-05-12', remark:'', status:'published' },
  { id:'s_023', name:'手持风扇', account:'大号', receiveDate:'2026/3/23', deadline:'2026-04-07', remark:'', status:'published' },
  ...
  { id:'s_026', name:'纽益宝鱼油', account:'大号', receiveDate:'2026-04-28', deadline:'2026-05-13', remark:'', status:'published' },
  ...
  { id:'s_030', name:'ph咖啡', account:'大号', receiveDate:'2026-05-07', deadline:'2026-05-22', remark:'', status:'unpublished' },
  { id:'s_031', name:'宁心', account:'大号', receiveDate:'2026-05-01', deadline:'2026-05-16', remark:'', status:'published' },
  { id:'s_032', name:'倍加洁牙刷', account:'小号', receiveDate:'2026/5/11', deadline:'2026-05-26', remark:'', status:'published' },
  { id:'s_033', name:'脆升升礼盒', account:'小号', receiveDate:'2026/5/16', deadline:'2026-05-31', remark:'', status:'published' },
  { id:'s_034', name:'滴露消毒液', account:'小号', receiveDate:'2026/5/17', deadline:'2026-06-01', remark:'', status:'published' },
  { id:'s_035', name:'珀莱雅', account:'小号', receiveDate:'2026/5/17', deadline:'2026-06-01', remark:'', status:'published' },
  { id:'s_036', name:'答非冰感毛巾', account:'小号', receiveDate:'2026/6/3', deadline:'2026-06-18', remark:'', status:'published' },
  { id:'s_037', name:'润培护发精油', account:'小号', receiveDate:'2026/6/4', deadline:'2026-06-19', remark:'', status:'published' },
  { id:'s_038', name:'皮带', account:'小号', receiveDate:'2026/6/4', deadline:'2026-06-19', remark:'', status:'published' },
  { id:'s_039', name:'宁心', account:'小号', receiveDate:'2026/3/3', deadline:'2026-03-18', remark:'', status:'published' },
  { id:'s_040', name:'后谷咖啡', account:'小号', receiveDate:'2026/6/5', deadline:'2026-06-20', remark:'', status:'published' },
  { id:'s_041', name:'可靠冰凉毛巾', account:'小号', receiveDate:'2026/6/5', deadline:'2026-06-20', remark:'', status:'published' },
  { id:'s_042', name:'星帮尼湿巾', account:'小号', receiveDate:'2026/6/9', deadline:'2026-06-24', remark:'', status:'published' },
  { id:'s_043', name:'官栈花胶', account:'小号', receiveDate:'2026/6/9', deadline:'2026-06-24', remark:'', status:'published' },
  { id:'s_044', name:'奶酪', account:'小号', receiveDate:'2026/6/9', deadline:'2026-06-24', remark:'', status:'published' },
  { id:'s_045', name:'植研加睫毛胶水新', account:'小号', receiveDate:'2026/6/16', deadline:'2026-07-01', remark:'', status:'published' },
  { id:'s_046', name:'植研加睫毛胶水旧', account:'小号', receiveDate:'2026/6/24', deadline:'2026-07-09', remark:'', status:'published' },
  { id:'s_047', name:'铁剂', account:'小号', receiveDate:'2026/6/24', deadline:'2026-07-09', remark:'', status:'published' },
  { id:'s_048', name:'童颜纪面膜', account:'小号', receiveDate:'2026/6/26', deadline:'2026-07-11', remark:'', status:'published' },
  { id:'s_049', name:'泥巴派', account:'小号', receiveDate:'2026/6/26', deadline:'2026-07-11', remark:'', status:'published' },
  { id:'s_050', name:'百草妈咪洁面泡沫', account:'小号', receiveDate:'2026/6/16', deadline:'2026-07-01', remark:'', status:'published' },
  { id:'s_051', name:'一页精华', account:'小号', receiveDate:'2026/6/16', deadline:'2026-07-01', remark:'', status:'published' },
  { id:'s_052', name:'丹泊沐浴露', account:'小号', receiveDate:'2026/6/16', deadline:'2026-07-01', remark:'', status:'published' },
  { id:'s_053', name:'生理盐水湿巾', account:'小号', receiveDate:'2026/6/16', deadline:'2026-07-01', remark:'', status:'published' },
  { id:'s_054', name:'衣物香氛挂件', account:'小号', receiveDate:'2026/6/16', deadline:'2026-07-01', remark:'', status:'hit' },
  { id:'s_055', name:'祛湿轻', account:'小号', receiveDate:'2026/3/1', deadline:'2026-03-16', remark:'', status:'hit' },
  { id:'s_056', name:'洁比兔 湿巾', account:'小号', receiveDate:'2026-03-24', deadline:'2026-04-08', remark:'', status:'hit' },
  { id:'s_057', name:'洁比兔益生菌洗液', account:'小号', receiveDate:'2026/3/24', deadline:'2026-04-08', remark:'', status:'hit' },
  { id:'s_058', name:'绵绵的羊', account:'小号', receiveDate:'2026/4/28', deadline:'2026-05-13', remark:'', status:'published' },
  { id:'s_059', name:'宝玑米脱毛膏', account:'小号', receiveDate:'2026/4/28', deadline:'2026-05-13', remark:'', status:'published' },
  { id:'s_060', name:'纯耕六味地黄丸', account:'小号', receiveDate:'2026/4/23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_061', name:'纯耕黄精人参', account:'小号', receiveDate:'2026/4/23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_062', name:'珀芙研等渗面膜', account:'小号', receiveDate:'2026/4/23', deadline:'2026-05-08', remark:'', status:'hit' },
  { id:'s_063', name:'珀芙研蛋白胶原面膜', account:'小号', receiveDate:'2026/5/3', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_064', name:'珀芙研冷膜', account:'小号', receiveDate:'2026/5/3', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_065', name:'珀芙研修护霜', account:'小号', receiveDate:'2026/5/3', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_066', name:'珀芙研修护霜小样', account:'小号', receiveDate:'2026/5/16', deadline:'2026-05-31', remark:'', status:'published' },
  { id:'s_067', name:'柏芙妍油敏霜', account:'小号', receiveDate:'2026/5/16', deadline:'2026-05-31', remark:'', status:'published' },
  { id:'s_068', name:'珂拉琪唇釉礼盒', account:'小号', receiveDate:'2026/5/13', deadline:'2026-05-28', remark:'2条起投', status:'published' },
  { id:'s_069', name:'润培沐浴露', account:'小号', receiveDate:'2026/5/18', deadline:'2026-06-02', remark:'', status:'published' },
  { id:'s_070', name:'倍爱健', account:'小号', receiveDate:'2026/5/11', deadline:'2026-05-26', remark:'', status:'published' },
  { id:'s_071', name:'fiboo富铁软糖', account:'小号', receiveDate:'2026/4/28', deadline:'2026-05-13', remark:'', status:'published' },
  { id:'s_072', name:'美那有营养软糖', account:'小号', receiveDate:'2026/4/29', deadline:'2026-05-14', remark:'', status:'published' },
  { id:'s_073', name:'香蕉饮', account:'小号', receiveDate:'2026/4/23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_074', name:'olly女维', account:'小号', receiveDate:'2026/4/23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_075', name:'olly褪黑素', account:'小号', receiveDate:'2026/4/23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_076', name:'洗衣凝珠', account:'小号', receiveDate:'2026/5/5', deadline:'2026-05-20', remark:'', status:'published' },
  { id:'s_077', name:'茵缇玛', account:'小号', receiveDate:'2026/5/6', deadline:'2026-05-21', remark:'', status:'published' },
  { id:'s_078', name:'苏卡咖啡', account:'小号', receiveDate:'2026/5/5', deadline:'2026-05-20', remark:'', status:'published' },
  { id:'s_079', name:'ph咖啡', account:'小号', receiveDate:'2026/4/18', deadline:'2026-05-03', remark:'', status:'published' },
  { id:'s_080', name:'斯维诗液体钙', account:'小号', receiveDate:'2026/3/26', deadline:'2026-04-10', remark:'', status:'abandoned' },
  { id:'s_094', name:'祛湿清', account:'小小号', receiveDate:'2026-03-01', deadline:'2026-03-16', remark:'', status:'unpublished' },
  ...
  { id:'s_116', name:'香体糖', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_117', name:'olly褪黑素', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  ...
  { id:'s_125', name:'重颜纪面膜', account:'小号', receiveDate:'2026/6/26', deadline:'2026-07-11', remark:'', status:'unpublished' },
  { id:'s_126', name:'珀芙研油敏霜', account:'小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_127', name:'洁比兔湿厕纸', account:'小号', receiveDate:'2026/3/24', deadline:'2026-04-08', remark:'', status:'hit' },
  ...
  savingsData: {
    ...
    records: {
      ...
      '2026-02': { target: 210000, actual: 207290, details: { '支付宝1': 98600, '支付宝2': 2590, '博时': 12000, '同花顺': 25500, '华泰': 46700, '东方': 9000, '卡': 12900 } },
      '2026-03': { target: 216000, actual: 202650, details: { '支付宝1': 96800, '支付宝2': 2600, '博时': 11450, '同花顺': 24800, '华泰': 45000, '东方': 9000, '卡': 10000, '微信': 3000 } },
      '2026-04': { target: 222000, actual: 209240, details: { '支付宝1': 99700, '支付宝2': 3660, '博时': 11880, '同花顺': 24000, '华泰': 45700, '东方': 8300, '卡': 6000, '中信': 10000 } },
      '2026-05': { target: 228000, actual: 223100, details: { '支付宝1': 111400, '支付宝2': 1200, '博时': 12700, '同花顺': 24300, '华泰': 49500, '东方': 8000, '中信': 16000 } },
      '2026-06': { target: 234000, actual: 229400, details: { '支付宝1': 110600, '支付宝2': 3400, '博时': 12500, '同花顺': 22900, '华泰': 50000, '东方': 8000, '中信': 16000, '工行': 6000 } },
      '2026-07': { target: 240000, actual: 0, details: {} },
      '2026-08': { target: 246000, actual: 0, details: {} },
      '2026-09': { target: 252000, actual: 0, details: {} },
      '2026-10': { target: 258000, actual: 0, details: {} },
      '2026-11': { target: 264000, actual: 0, details: {} },
