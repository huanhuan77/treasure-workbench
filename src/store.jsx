...
const defaultData = {
  ...
  samples: [
  { id:'s_001', name:'冰格', account:'大号', receiveDate:'2026/4/17', deadline:'', remark:'', status:'unpublished' },
  { id:'s_002', name:'口罩', account:'大号', receiveDate:'2026/4/18', deadline:'', remark:'', status:'unpublished' },
  { id:'s_003', name:'柳丝木洁面乳', account:'大号', receiveDate:'2026/5/7', deadline:'', remark:'', status:'unpublished' },
  ...
  { id:'s_012', name:'珀芙研闪光棒', account:'大号', receiveDate:'2026/5/3', deadline:'', remark:'', status:'published' },
  { id:'s_013', name:'珀芙研修护霜小样', account:'大号', receiveDate:'2026/5/16', deadline:'', remark:'', status:'published' },
  ...
  { id:'s_016', name:'衣物香氛挂件', account:'大号', receiveDate:'2026/4/24', deadline:'', remark:'', status:'hit' },
  { id:'s_017', name:'浮汀遮瑕液', account:'大号', receiveDate:'2026/5/16', deadline:'', remark:'出单 佣金10%', status:'hit' },
  ...
  { id:'s_021', name:'讯姆钢化膜', account:'大号', receiveDate:'2026/3/16', deadline:'', remark:'', status:'published' },
  { id:'s_022', name:'袋鼠妈妈沐浴露洗发水', account:'大号', receiveDate:'2026/4/27', deadline:'', remark:'', status:'published' },
  { id:'s_023', name:'手持风扇', account:'大号', receiveDate:'2026/3/23', deadline:'', remark:'', status:'published' },
  ...
  { id:'s_046', name:'植研加睫毛胶水旧', account:'小号', receiveDate:'', deadline:'', remark:'', status:'unpublished' },
  { id:'s_047', name:'铁剂', account:'小号', receiveDate:'2026/6/24', deadline:'', remark:'', status:'unpublished' },
  ...
  { id:'s_052', name:'丹泊沐浴露', account:'小号', receiveDate:'2026/6/16', deadline:'', remark:'', status:'published' },
  { id:'s_053', name:'生理盐水湿巾', account:'小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_054', name:'衣物香氛挂件', account:'小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_055', name:'祛湿轻', account:'小号', receiveDate:'2026/3/1', deadline:'', remark:'', status:'hit' },
  { id:'s_056', name:'洁比兔 湿巾', account:'小号', receiveDate:'2026-03-24', deadline:'', remark:'', status:'hit' },
  { id:'s_057', name:'洁比兔益生菌洗液', account:'小号', receiveDate:'2026/3/24', deadline:'', remark:'', status:'hit' },
  { id:'s_058', name:'绵绵的羊', account:'小号', receiveDate:'2026/4/28', deadline:'', remark:'', status:'hit' },
  { id:'s_059', name:'宝玑米脱毛膏', account:'小号', receiveDate:'2026/4/28', deadline:'', remark:'', status:'hit' },
  { id:'s_060', name:'纯耕六味地黄丸', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'', status:'published' },
  { id:'s_061', name:'纯耕黄精人参', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'', status:'published' },
  { id:'s_062', name:'珀芙研等渗面膜', account:'小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_063', name:'珀芙研蛋白胶原面膜', account:'小号', receiveDate:'2026/5/3', deadline:'', remark:'', status:'hit' },
  { id:'s_064', name:'珀芙研冷膜', account:'小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_065', name:'珀芙研修护霜', account:'小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_066', name:'珀芙研修护霜小样', account:'小号', receiveDate:'2026/5/16', deadline:'', remark:'', status:'published' },
  { id:'s_067', name:'柏芙妍油敏霜', account:'小号', receiveDate:'', deadline:'', remark:'', status:'unpublished' },
  { id:'s_068', name:'珂拉琪唇釉礼盒', account:'小号', receiveDate:'2026/5/13', deadline:'', remark:'2条起投', status:'published' },
  { id:'s_069', name:'润培沐浴露', account:'小号', receiveDate:'2026/5/18', deadline:'', remark:'', status:'published' },
  { id:'s_070', name:'倍爱健', account:'小号', receiveDate:'2026/5/11', deadline:'', remark:'', status:'published' },
  { id:'s_071', name:'fiboo富铁软糖', account:'小号', receiveDate:'2026/4/28', deadline:'', remark:'', status:'published' },
  { id:'s_072', name:'美那有营养软糖', account:'小号', receiveDate:'2026/4/29', deadline:'', remark:'', status:'published' },
  { id:'s_073', name:'香蕉饮', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'', status:'published' },
  { id:'s_074', name:'olly女维', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'', status:'published' },
  { id:'s_075', name:'olly褪黑素', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'', status:'published' },
  { id:'s_076', name:'洗衣凝珠', account:'小号', receiveDate:'2026/5/5', deadline:'', remark:'', status:'published' },
  { id:'s_077', name:'茵缇玛', account:'小号', receiveDate:'2026/5/6', deadline:'', remark:'', status:'published' },
  { id:'s_078', name:'苏卡咖啡', account:'小号', receiveDate:'2026/5/5', deadline:'', remark:'', status:'published' },
  { id:'s_079', name:'ph咖啡', account:'小号', receiveDate:'2026/4/18', deadline:'', remark:'', status:'published' },
  { id:'s_080', name:'斯维诗液体钙', account:'小号', receiveDate:'2026/3/26', deadline:'', remark:'', status:'published' },
  ...
  { id:_086', name:'铁剂', account:'小小号', receiveDate:'2026-06-24', deadline:'', remark:'', status:'published' },
  { id:'s  { id:'s_088', name:'泥巴派', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { i id:'s_090', name:'一页精华', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:{ id:'s_092', name:'生理盐水湿巾', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:' name:'祛湿清', account:'小小号', receiveDate:'2026-03-01', deadline:'', remark:'', status:'unpublished' },
  { id:'s_095',:'s_096', name:'洁比兔益生菌洗液', account:'小小号', receiveDate:'2026-03-24', deadline:'', remark:'', status:'hit' 
  { id:'s_098', name:'宝玑米脱毛膏', account:'小小号', receiveDate:'2026-04-28', deadline:'', remark:'', status:'publi, status:'hit' },
  { id:'s_100', name:'纯耕黄精英人参', account:'小小号', receiveDate:'2026-04-23', deadline:'', re', status:'abandoned' },
  { id:'s_102', name:'珀芙研蛋白胶原面膜', account:'小小号', receiveDate:'2026-05-03', deadline:'', remaark:'', status:'abandoned' },
  { id:'s_104', name:'珀芙研修护霜', account:'小小号', receiveDate:'', deadline:'', rem remark:'', status:'abandoned' },
  ...
  { id:'s_109', name:'纯耕六味地黄丸', account:'小小号', receiveDate:'', deadline:'', remark:'', sts:'published' },
  { id:'s_111', name:'美那有营养软糖', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'pu:'published' },
  { id:'s_113', name:'香蕉牛奶', account:'小小号', receiveDate:'', deadline:'', remark:'', status,
    { id:'s_115', name:'无糖清凉糖', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'hit' },
  { id:'s_116','olly褪黑素', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_118', name:'南瓜籽'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_120', name:'红花贴', account:'小小号', receivete:'', deadline:'', remark:'', status:'unpublished' },
  { id:'s_122', name:'腿腿丸', account:'小小号', receiveDate:'', remark:'', status:'unpublished' },
  { id:'s_124', name:'洛神月褪黑素', account:'小小号', receiveDate:'', deadline:'', remark'', remark:'', status:'unpublished' },
  { id:'s_126', name:'珀芙研油敏霜', account:'小号', receiveDate:'', deadlin', deadline:'', remark:'', status:'hit' },
  { id:'s_128', name:'南瓜茶', account:'小小号', receiveDate:'', deadlie:'', remark:'', status:'published' }
],
  transactions: [
    { id: 'seed_tx_e001', type: 'expense', categoryi001', type: 'income', category: 'withdraw', account: '晚梨不吃梨', amount: 500.0, date: '2026-01-15', remark: '晚 7.92, date: '', remark: '平板支架', createdAt: 0 },
    { id: 'seed_tx_i002', type: 'income', category: 'come003', type: 'expense', category: 'prop', account: '', amount: 2.41, date: '', remark: '相框', createdAt: 0 },
  02-22', remark: '广东刘亦菲提现', createdAt: 0 },
    { id: 'seed_tx_e004', type: 'expense', category: 'other_expensncome', category: 'withdraw', account: '晚梨不吃梨', amount: 143.0, date: '2026-02-28', remark: '晚梨海淘提现', createdAe: '', remark: '英文杂志', createdAt: 0 },
    { id: 'seed_tx_i005', type: 'income', category: 'sample', account:pense', category: 'other_expense', account: '', amount: 8.39, date: '', remark: '向日葵', createdAt: 0 },
    {-03-03', remark: '广东刘亦菲海淘提现', createdAt: 0 },
    ...
    { id: 'seed_tx_i008', type: 'income', categord: 'seed_tx_e009', type: 'expense', category: 'other_expense', account: '', amount: 980.0, date: '', remark: '会员', createdAt: 0 },
    ...
    { id: 'seed_tx_ik: '广东刘亦菲海淘提现', createdAt: 0 },
