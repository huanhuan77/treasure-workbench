...
const defaultData = {
  ...
  { id:'s_006', name:'植研加睫毛胶水新', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-06-16', deadline:'2026-07-01', remark:'3条', status:'published' },
  ...
  { id:'s_009', name:'珀芙研等渗面膜', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-04-23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_010', name:'珀芙研蛋白胶原面膜', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-05-03', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_011', name:'珀芙研油敏霜', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_012', name:'珀芙研闪光棒', account:'广东刘亦菲', receiveDate:'2026-05-03', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_013', name:'珀芙研修护霜小样', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-05-16', deadline:'2026-05-31', remark:'', status:'published' },
  { id:'s_014', name:'珀芙研冷膜', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-05-03', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_015', name:'珀芙研修护霜', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-05-03', deadline:'2026-05-18', remark:'', status:'published' },
  { id:'s_016', name:'衣物香氛挂件', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-04-24', deadline:'2026-05-09', remark:'', status:'published' },
  ...
  { id:'s_019', name:'祛湿清', accounts:['广东刘亦菲','努力成为富婆'], account:'广东刘亦菲', receiveDate:'2026-03-01', deadline:'2026-03-16', remark:'', status:'published' },
  { id:'s_020', name:'植研加睫毛胶水旧', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-06-24', deadline:'2026-07-09', remark:'', status:'published' },
  ...
  { id:'s_024', name:'绵绵的羊', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-04-28', deadline:'2026-05-13', remark:'', status:'published' },
  ...
  { id:'s_027', name:'宝玑米脱毛膏', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-04-28', deadline:'2026-05-13', remark:'', status:'published' },
  { id:'s_028', name:'生理盐水', account:'广东刘亦菲', receiveDate:'', deadline:'', remark:'', status:'un_arrived' },
  { id:'s_029', name:'无界香水', account:'广东刘亦菲', receiveDate:'', deadline:'', remark:'', status:'un_arrived' },
  { id:'s_030', name:'ph咖啡', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-05-07', deadline:'2026-05-22', remark:'', status:'published' },
  { id:'s_031', name:'宁心', accounts:['广东刘亦菲','晚梨不吃梨'], account:'广东刘亦菲', receiveDate:'2026-05-01', deadline:'2026-05-16', remark:'', status:'published' },
  ...
  { id:'s_073', name:'香蕉饮', accounts:['晚梨不吃梨','努力成为富婆'], account:'晚梨不吃梨', receiveDate:'2026-04-23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_074', name:'olly女维', accounts:['晚梨不吃梨','努力成为富婆'], account:'晚梨不吃梨', receiveDate:'2026-04-23', deadline:'2026-05-08', remark:'', status:'published' },
  { id:'s_075', name:'olly褪黑素', accounts:['晚梨不吃梨','努力成为富婆'], account:'晚梨不吃梨', receiveDate:'2026-04-23', deadline:'2026-05-08', remark:'', status:'published' },
  ...
  todos: [],  // 待办事项：{ id, title, done, due('YYYY-MM-DD' 可为空=无截止日), createdAt, updatedAt }
}
...
function migrateSample(s) {
  ...
  let status
  const st = s.status
  // 旧 6 态 → 新 5 态（未到货 / 已到货未拍摄 / 已拍摄未发布 / 已发布 / 放弃）
  if (st === 'published' || st === 'published_free' || st === 'published_paid' || st === 'hit') {
    status = 'published'
  } else if (st === 'shot') {
    status = 'shot'
  } else if (st === 'abandoned') {
    status = 'abandoned'
  } else if (st === 'unpublished') {
    // 旧「未发布」按到货情况拆成未到货 / 已到货未拍摄
    status = s.isArrived ? 'arrived' : 'un_arrived'
  } else if (st) {
    status = st // 已是新 key，原样保留
  } else {
    status = s.isArrived ? 'arrived' : 'un_arrived'
  }
...
export function StoreProvider({ children }) {
  ...
  // ── 待办事项：独立于每日计划的待办池，due 可为空（表示无截止日期）
  const addTodo = useCallback((todo) => {
    ...
    setData((d) => ({ ...d, todos: [newTodo, ...(d.todos || [])] }))
    return newTodo.id
  }, [])
  ...
  const applySyncResult = useCallback((mergedMain) => {
    ...
    setData((d) => {
      const next = {
        ...
        todos: mergedMain.todos ?? d.todos,
      }
