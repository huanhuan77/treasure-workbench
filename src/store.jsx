...
const defaultData = {
  ...
  { id:'s_008', name:'一次性内裤', account:'大号', receiveDate:'', deadline:'', remark:'1', status:'published' },
  { id:'s_009', name:'珀芙研等渗面膜', account:'大号', receiveDate:'', deadline:'', remark:'', status:'hit' },
  { id:'s_010', name:'珀芙研蛋白胶原面膜', account:'大号', receiveDate:'2026/5/3', deadline:'', remark:'5', status:'published' },
  { id:'s_011', name:'珀芙研油敏霜', account:'大号', receiveDate:'', deadline:'', remark:'1', status:'published' },
  { id:'s_012', name:'珀芙研闪光棒', account:'大号', receiveDate:'2026/5/3', deadline:'', remark:'6', status:'published' },
  { id:'s_013', name:'珀芙研修护霜小样', account:'大号', receiveDate:'2026/5/16', deadline:'', remark:'4', status:'published' },
  ...
  { id:'s_016', name:'衣物香氛挂件', account:'大号', receiveDate:'2026/4/24', deadline:'', remark:'2', status:'hit' },
  ...
  { id:'s_021', name:'讯姆钢化膜', account:'大号', receiveDate:'2026/3/16', deadline:'', remark:'1', status:'published' },
  { id:'s_022', name:'袋鼠妈妈沐浴露洗发水', account:'大号', receiveDate:'2026/4/27', deadline:'', remark:'5', status:'published' },
  { id:'s_023', name:'手持风扇', account:'大号', receiveDate:'2026/3/23', deadline:'', remark:'1', status:'published' },
  ...
  { id:'s_050', name:'百草妈咪洁面泡沫', account:'小号', receiveDate:'', deadline:'', remark:'2', status:'published' },
  { id:'s_051', name:'一页精华', account:'小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_052', name:'丹泊沐浴露', account:'小号', receiveDate:'2026/6/16', deadline:'', remark:'3', status:'published' },
  { id:'s_053', name:'生理盐水湿巾', account:'小号', receiveDate:'', deadline:'', remark:'1', status:'published' },
  { id:'s_054', name:'衣物香氛挂件', account:'小号', receiveDate:'', deadline:'', remark:'3', status:'published' },
  { id:'s_055', name:'祛湿轻', account:'小号', receiveDate:'2026/3/1', deadline:'', remark:'2', status:'hit' },
  { id:'s_056', name:'洁比兔 湿巾', account:'小号', receiveDate:'2026-03-24', deadline:'', remark:'', status:'hit' },
  { id:'s_057', name:'洁比兔益生菌洗液', account:'小号', receiveDate:'2026/3/24', deadline:'', remark:'9', status:'hit' },
  { id:'s_058', name:'绵绵的羊', account:'小号', receiveDate:'2026/4/28', deadline:'', remark:'5', status:'hit' },
  { id:'s_059', name:'宝玑米脱毛膏', account:'小号', receiveDate:'2026/4/28', deadline:'', remark:'4', status:'hit' },
  { id:'s_060', name:'纯耕六味地黄丸', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'2', status:'published' },
  { id:'s_061', name:'纯耕黄精人参', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'2', status:'published' },
  { id:'s_062', name:'珀芙研等渗面膜', account:'小号', receiveDate:'', deadline:'', remark:'1', status:'published' },
  { id:'s_063', name:'珀芙研蛋白胶原面膜', account:'小号', receiveDate:'2026/5/3', deadline:'', remark:'3', status:'hit' },
  ...
  { id:'s_066', name:'珀芙研修护霜小样', account:'小号', receiveDate:'2026/5/16', deadline:'', remark:'2', status:'published' },
  ...
  { id:'s_069', name:'润培沐浴露', account:'小号', receiveDate:'2026/5/18', deadline:'', remark:'3', status:'published' },
  { id:'s_070', name:'倍爱健', account:'小号', receiveDate:'2026/5/11', deadline:'', remark:'3', status:'published' },
  { id:'s_071', name:'fiboo富铁软糖', account:'小号', receiveDate:'2026/4/28', deadline:'', remark:'2', status:'published' },
  { id:'s_072', name:'美那有营养软糖', account:'小号', receiveDate:'2026/4/29', deadline:'', remark:'2', status:'published' },
  { id:'s_073', name:'香蕉饮', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'2', status:'published' },
  { id:'s_074', name:'olly女维', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'1', status:'published' },
  { id:'s_075', name:'olly褪黑素', account:'小号', receiveDate:'2026/4/23', deadline:'', remark:'1', status:'published' },
  { id:'s_076', name:'洗衣凝珠', account:'小号', receiveDate:'2026/5/5', deadline:'', remark:'2', status:'published' },
  { id:'s_077', name:'茵缇玛', account:'小号', receiveDate:'2026/5/6', deadline:'', remark:'2', status:'published' },
  { id:'s_078', name:'苏卡咖啡', account:'小号', receiveDate:'2026/5/5', deadline:'', remark:'1', status:'published' },
  { id:'s_079', name:'ph咖啡', account:'小号', receiveDate:'2026/4/18', deadline:'', remark:'2', status:'published' },
  { id:'s_080', name:'斯维诗液体钙', account:'小号', receiveDate:'2026/3/26', deadline:'', remark:'2', status:'published' },
  ...
  { id:'s_094', name:'祛湿清', account:'小小号', receiveDate:'2026-03-01', deadline:'', remark:'4', status:'unpublished' },
  ...
  { id:'s_114', name:'olly女维', account:'小小号', receiveDate:'', deadline:'', remark:'9', status:'hit' },
  { id:'s_115', name:'无糖清凉糖', account:'小小号', receiveDate:'', deadline:'', remark:'10', status:'hit' },
  { id:'s_116', name:'香体糖', account:'小小号', receiveDate:'', deadline:'', remark:'4', status:'published' },
  { id:'s_117', name:'olly褪黑素', account:'小小号', receiveDate:'', deadline:'', remark:'8', status:'published' },
  { id:'s_118', name:'南瓜籽', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_119', name:'西梅软糖', account:'小小号', receiveDate:'', deadline:'', remark:'6', status:'published' },
  { id:'s_120', name:'红花贴', account:'小小号', receiveDate:'', deadline:'', remark:'3', status:'published' },
  { id:'s_121', name:'巧尼芙', account:'小小号', receiveDate:'', deadline:'', remark:'6', status:'unpublished' },
  { id:'s_122', name:'腿腿丸', account:'小小号', receiveDate:'', deadline:'', remark:'', status:'published' },
  { id:'s_123', name:'复合维B', account:'小小号', receiveDate:'', deadline:'', remark:'1', status:'unpublished' },
  ...
  { id:'s_127', name:'洁比兔湿厕纸', account:'小号', receiveDate:'2026/3/24', deadline:'', remark:'8', status:'hit' },
  { id:'s_128', name:'南瓜茶', account:'小小号', receiveDate:'', deadline:'', remark:'2', status:'unpublished' },
  { id:'s_129', name:'香蕉饮', account:'小小号', receiveDate:'', deadline:'', remark:'3', status:'published' }
],
  transactions: [
